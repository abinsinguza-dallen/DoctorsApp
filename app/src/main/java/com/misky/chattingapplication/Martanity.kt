...
import com.misky.chattingapplication.databinding.ActivityMartanityBinding

class Martanity : AppCompatActivity() {
    lateinit var binding:ActivityMartanityBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityMartanityBinding.inflate(layoutInflater)
    ...
    fun displayContacts(){
        ...
        binding.rvMartanity.layoutManager= LinearLayoutManager(this)
        binding.rvMartanity.adapter=contactsAdaptor
    }
}