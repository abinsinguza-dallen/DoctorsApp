...
import com.misky.chattingapplication.databinding.ActivityEyesDoctorsBinding

class EyesDoctors : AppCompatActivity() {
    lateinit var binding: ActivityEyesDoctorsBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityEyesDoctorsBinding.inflate(layoutInflater)
    ...
    fun displayContacts(){
        ...
        binding.rvEyes.layoutManager= LinearLayoutManager(this)
        binding.rvEyes.adapter=contactsAdaptor
    }
